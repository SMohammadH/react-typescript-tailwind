...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative  max-w-xs mx-auto dark">
      <div
        className={`absolute mb-10 ml-5 inset-0 bg-gradient-to-r from-${imgBack}-200 dark:from-${imgBack}-800 to-${imgBack}-400 shadow-lg transform -skew-y-3 sm:skew-y-0 sm:-rotate-6 rounded-3xl`}
      ></div>
      <div className="relative py-7 px-2 md:mb-0 flex flex-col ">
        <div className="shadow-lg rounded-3xl bg-primary text-primary px-4 py-10 mr-6 transform translate-x-6 -translate-y-6  ">
          <div
