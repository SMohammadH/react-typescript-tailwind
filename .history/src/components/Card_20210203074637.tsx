...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative max-w-xs sm:mx-auto ">
      <div
        className={`absolute mb-10 ml-5 inset-0 bg-gradient-to-r from-${imgBack}-200 to-${imgBack}-400 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 rounded-3xl`}
      ></div>
      <div className="relative md:mb-0 flex flex-col ">
        <div className="pattern-dots-md gray-light px-4 py-8 mr-2">
          <div className="rounded-3xl bg-primary text-primary px-4 py-8 mr-20 transform translate-x-6 -translate-y-6  ">
            <div
