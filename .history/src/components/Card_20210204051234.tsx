...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative max-w-sm md:max-w-xs mx-auto ">
      <div
        className={`absolute mr-2 ml-8 mb-11 inset-0 bg-gradient-to-r from-${imgBack}-200 to-${imgBack}-400 dark:from-gray-800 dark:to-${imgBack}-700 shadow-lg transform -skew-y-3 sm:skew-y-0 sm:-rotate-6 rounded-3xl`}
      ></div>
