...
export const Header = () => {
  return (
    <div className="h-full bg-secondary">
      <div
        className="text-center w-full h-auto bg-cover relative overflow-hidden"
        style={{
          backgroundImage: `url(${Img})`,
          borderRadius: '0 0 85% 85% / 30%',
        }}
      >
        <div className="w-full h-full p-10 text-secondary shadow-md bg-gradient-to-b  to-gray-600 from-transparent">
