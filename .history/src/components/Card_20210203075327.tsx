...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative py-1 max-w-xs sm:mx-auto ">
      <div
        className={`absolute mb-10 ml-5 inset-0 bg-gradient-to-r from-${imgBack}-400 to-${imgBack}-200 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 rounded-3xl`}
      ></div>
