...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative max-w-xs sm:mx-auto ">
      <div
        className={`absolute mb-10 ml-5 pr-10 inset-0 bg-${imgBack}-300 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl`}
      ></div>
      <div className="relative md:mb-0 flex flex-col ">
        <div className="pattern-dots-md gray-light px-4 py-6">
