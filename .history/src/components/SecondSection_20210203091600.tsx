...
const text = [
  ...
  {
    redux: 'Redux also used for state management which we are going to explain',
  },
  {
    typescript:
      'Typescript is used for type annotation and prevent possible errors during coding.',
  },
  { reactRouter: 'sdfsdf' },
  { tailwind: 'sdfsdf' },
  { sass: 'sdfsdf' },
