...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative  max-w-xs mx-auto">
      <div
        className={`absolute mb-10 ml-5 inset-0 bg-gradient-to-r from-${imgBack}-200 to-${imgBack}-400 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-4 rounded-3xl`}
      ></div>
