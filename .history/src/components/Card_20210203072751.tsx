...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative max-w-xs sm:mx-auto px-10">
      <div
        className={`absolute inset-0 bg-${imgBack}-300 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl`}
      ></div>
      <div className="relative md:mb-0 mb-6 flex flex-col">
        <div className="pattern-dots-md gray-light px-8 py-6">
          <div className="rounded bg-primary text-primary py-4 px-8 transform translate-x-6 -translate-y-6  ">
            <div
