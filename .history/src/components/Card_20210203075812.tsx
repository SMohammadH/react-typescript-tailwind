...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative py-2 max-w-xs sm:mx-auto ">
      <div
      ...
      <div className="relative py-7 px-2 md:mb-0 flex flex-col ">
        <div className="rounded-3xl bg-primary text-primary px-4 py-10 mr-5 transform translate-x-6 -translate-y-6  ">
          <div
