...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative max-w-xs sm:mx-auto ">
      ...
      ></div>
      <div className="relative py-6 px-3 md:mb-0 flex flex-col ">
        <div className="rounded-3xl bg-primary text-primary px-2 py-8 mr-2 transform translate-x-6 -translate-y-6  ">
          <div
