...
export const Header = () => {
  return (
    <div
      className="text-center  w-full max-h-full bg-cover bg-fixed relative overflow-hidden"
      style={{
        backgroundImage: `url(${Img})`,
        borderRadius: '0 0 85% 85% / 30%',
      }}
    >
      <div className="w-full p-10 text-secondary bg-secondary shadow-md bg-gradient-to-b  to-gray-600 from-transparent">
