  ...
  return (
    <div className="relative max-w-xs sm:mx-auto ">
      ...
      <div className="relative md:mb-0 flex flex-col ">
        <div className="pattern-dots-md gray-light px-4 py-8 left-4">
          <div className="rounded-3xl bg-primary text-primary px-4 py-8  transform translate-x-6 -translate-y-6  ">
            <div
