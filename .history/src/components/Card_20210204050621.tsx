...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative max-w-sm md:max-w-xs mx-auto ">
      <div
        className={`absolute mx-14 my-2 inset-0 bg-gradient-to-r from-${imgBack}-200 to-${imgBack}-400 dark:from-${imgBack}-700 dark:to-${imgBack}-900 shadow-lg transform -skew-y-3 sm:skew-y-0 sm:-rotate-6 rounded-3xl`}
      ></div>
