...
export const SecondSection = () => {
  return (
    <div className="bg-secondary text-secondary">
      <div class="max-w-screen-xl mx-auto px-5 py-24 md:fl">
        <div class="text-center mb-20">
          <h1 class="text-accent mb-4 text-4xl leading-10 tracking-tight sm:text-5xl sm:leading-none md:text-6xl">
            Technologies
          </h1>
