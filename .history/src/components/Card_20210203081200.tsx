...
export const Card: React.FC<Props> = ({
  ...
  return (
    <div className="relative  max-w-xs mx-auto">
      ...
      ></div>
      <div className="relative py-7 px-2 md:mb-0 flex flex-col  shadow-lg sm:rounded-3xl sm:p-20">
        <div className="rounded-3xl bg-primary text-primary px-4 py-10 mr-6 transform translate-x-6 -translate-y-6  ">
          <div
